...
export default {
  ...
  employeeProfileAPI: `${API_URL}/EmployeeProfile/GetEmployeeById?empId=`,
  ...
  getEmployeesAtManagerEnd: `${API_URL}/EmployeeProfile/GetResource`,
  ...
  getDailyAllEmployees: `${API_URL}/Attendance/GetReports?Date=`,
  getFullLeaveReport: `${API_URL}/Leave/GetLeavesReport?fromDate=`,
  getWorkModeEmployees: `${API_URL}/Leave/GetWorkModeReport?fromDate=`,
  getWorkModeById: `${API_URL}/Leave/GetEmployeeWorkModeDetailsById?empId=`,
  // getEmployeesLeavesFromLeaveApplication: `${API_URL}/Leave/GetAllocatedLeaves?empId=`,
  getLeavesByHR: `${API_URL}/Leave/GetOpenLeave`,
  ...
  getAllEmployeesForHR: `${API_URL}/EmployeeProfile/GetEmployeeWithId`,
  dismissSelfLeaveAllocationRequest: `${API_URL}/Leave/UpdateStatusBySelf`,
  updateLeaveAllocationRequest: `${API_URL}/Leave/UpdateLeaveAllocationStatus`,
  // Update Leave Allocation Request Body:
  ...
  //   "approvalType": "string",
  //   "approverId": 0,
  //   "approvalDate": "2023-12-12T05:56:10.850Z",
  //   "fiscalYear": "string",
  //   "totalLeavesAllocated": 0,
  //   "currentLeaveBalance": 0,
  //   "postingDate": "2023-12-12T05:56:10.850Z"
  // }
  // getPermissionAccess:

...
export default {
  ...
  attendenceAPI: `${API_URL}/Attendence/GetDailyAttendanceByEmpId?empId=`,
  ...
  GetDailyAttendanceByEmpId: `${API_URL}/Attendence/GetDailyAttendanceByEmpId`,
  getLeaveApprovers: `${API_URL}/Leave/GetLeaveApprover?empId=10352`,
};
